...
( function () {
	...
	THREE.TransformControls = function ( camera, domElement, visibleGizmo ) {
		...
		this.visible = false;
        this.visibleGizmo = visibleGizmo;
		...
		for ( var type in _gizmo ) {
			...
			if (this.visibleGizmo === undefined) {
                gizmoObj.visible = (type === _mode);
            } else {
                gizmoObj.visible = this.visibleGizmo;
			}
			this.add( gizmoObj );
